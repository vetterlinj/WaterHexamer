...
data = np.load('simulation1Broken/PythonData/data.npz')
# make a large matrix
coords =data['coords']
...
#the number that broke going to 15
print(count)
#the number that broke going to 6
print(count1)
#the number of weirdy ones for our first double donor
print(weird)
#
#

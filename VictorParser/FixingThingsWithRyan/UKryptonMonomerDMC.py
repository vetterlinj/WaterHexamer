...
for i in np.arange(0,5):
    if bunchofjobs == True:
        ...
        arg4= sys.argv[4]
        deltaTau=int(arg4)
        filename="Results/Multiple/Walkers/5000time/"+fnameExtension+f"_{i}"
        resultsfilename="Results/Multiple/Walkers/5000time/npzFiles/"+fnameExtension+f"_{i}"
    ...
    for i in np.arange(0,numTimeSteps):
        ...
        # print(len(coords))
    energies = getDemEnergies(coords)
    fullEnergies.append([numTimeSteps, np.average(energies) / (4.5563e-6)])

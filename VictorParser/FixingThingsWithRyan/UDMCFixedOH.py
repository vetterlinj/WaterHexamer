...
for weirdsimthingy in np.arange(0,1):
    ...
    for i in np.arange(0,5):
        ...
        def randommovement(coords,dimensions,deltaTau):
            ...
            for atom in np.arange(1, len(coords)-1,3):
                countmove += 1
                # if countmove % 3 == 0:
                #     # Oxygen
                #     if atomicMass==True:
        ...
        angstr=0.529177
        middlenumber=[-0.2399535*1.01,0.9272970*1.01,0.0000000]
        startingGeo=np.array([[0.9578400*1.3,0.0000000,0.0000000],
                             middlenumber,
                     [0.0000000,0.0000000,0.0000000]])/angstr
